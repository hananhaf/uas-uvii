...
const Pesanan = () => {
  ...
  return (
    <View style={styles.pesanan}>
      ...
      <Text style={[styles.pesanan2, styles.riwayatTypo]}>Pesanan</Text>
      <Pressable
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Pesanan1")}
      >
        <Text style={[styles.riwayatTypo, styles.riwayatTypo1]}>Dikirim</Text>
      </Pressable>
      <Text
        style={[
          styles.riwayat,
      ...
      <Image
        style={[styles.pesananInner, styles.frameIconLayout]}
        resizeMode="cover"
